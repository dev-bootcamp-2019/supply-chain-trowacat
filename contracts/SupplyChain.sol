...
/* Create a modifer that checks if the msg.sender is the owner of the contract */
  ...
  /* For each of the following modifiers, use what you learned about modifiers
   ...
   that the item with the given sku has the state ForSale. */
    modifier forSale (State state) {require (state == State.ForSale); _;}
  ...
  /* Add a keyword so the function can be paid. This function should transfer money
    ...
    function buyItem(uint sku) public payable forSale(items[sku].state) paidEnough(items[sku].price) checkValue(sku) {
  ...
  is the seller. Change the state of the item to shipped. Remember to call the event associated with this function!*/
    function shipItem(uint sku) public sold(items[sku].state) verifyCaller(msg.sender){
  ...
  is the buyer. Change the state of the item to received. Remember to call the event associated with this function!*/
    function receiveItem(uint sku) public shipped(items[sku].state) verifyCaller(msg.sender) {
